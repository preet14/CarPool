<%-- 
    ...
    Author     : user
--%>
<%@page import="Modal.PoolStatusDB"%>
<%
...
<body >
    ...
    <br>
            <%
                ...
                ArrayList<PoolStatusDB> al = (ArrayList<PoolStatusDB>)session.getAttribute("poolDet");
                if(al.size()!=0){
            %>
        ...
        <tr>
            ...
            <td><%=(al.get(i)).getFromLoc()%></td>
            <td><%=(al.get(i)).getToLoc()%></td>
            <%
                if(!(al.get(i)).isStatus())
                {
            %>
               <td><a href="prevStatusPool?fromLoc=<%=(al.get(i)).getFromLoc()%>&toLoc=<%=(al.get(i)).getToLoc()%>&emaill=<%=(al.get(i)).getEmail()%>">Accept</a></td>
            <%
                }
                else{
            %>
