<%-- 
    Document   : Ride
    Created on : Nov 15, 2018, 6:18:58 PM
    Author     : user
--%>
<%
...
<body >
            ...
            <table id = "tab">
				...
				<div class="topnav">
                                          ...
                                          <a class="active" href="Ride.jsp">Ride</a>
			...
			<td align="center">
			<h2><font style="font-size:100px;font-family:algerian;color:#FFFF33;">GET RIDE</font></h2>
                        <form action="PoolGet" method="post">
					   <table width="1000" border="0" cellspacing="5" cellpadding="4" align="center" style="background-color:black;width:60%;">
					      <font style="font-size:40px;font-family:algerian;color:white;">
					      <tr>
						    <td>
                                 <select name="from" style="max-width:100%;font-size:20pt;" required>
							...
							<td>
	                             <select name="to" style="max-width:100%;font-size:20pt;" required>
							...
							<td>
                                                            <input type="text" style="max-width:100%;font-size:20pt;" name="rdate" placeholder="dd-mm-yyyy" required="">
							</td>
                                                        <td>
                                                            <input type="text" style="max-width:100%;font-size:20pt;" name="rtime" placeholder="hh:mm" required="">
                                                        </td>
							<td>
